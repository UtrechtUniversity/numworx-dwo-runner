...
aws --profile prod s3 sync s3://cds.dwo.nl/apps/ s3://test-dwo-nl/uu-dev/apps/ --acl public-read $DRY --exclude "plantyn*" --exclude "test*" --exclude "noordhoff/*" --exclude "numworx-*" --exclude "en/*" --exclude "gr/*" --exclude "new/*" --exclude "mw/*" --exclude "negatief/*"
